...
- Added `OVERLEAF_HEADER_IMAGE_URL_LIGHT` and `OVERLEAF_HEADER_IMAGE_URL_LIGHT` to [`config-seed/variables.env`](https://github.com/overleaf/toolkit/blob/master/lib/config-seed/variables.env).
